...
namespace App\Http\Controllers\UserWebSite\CategorySection;
...
class CategorySectionWebsiteController extends Controller
{
    ...
    {
        return $this->categorySectionService->fetchCategorySection(ViewTypeEnum::Website->value)->response();
    }
