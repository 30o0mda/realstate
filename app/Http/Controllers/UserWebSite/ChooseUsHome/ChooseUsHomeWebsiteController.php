...
namespace App\Http\Controllers\UserWebSite\ChooseUsHome;
...
class ChooseUsHomeWebsiteController extends Controller
{
    ...
    {
        return $this->chooseUsHomeService->fetchChooseUsHome(ViewTypeEnum::Website->value)->response();
    }
