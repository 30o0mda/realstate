...
namespace App\Modules\GeneralData\Http\Resources\HeroSection;
use App\Modules\Organization\Http\Resources\OrganizationEmployeeResource;
use App\Modules\Organization\Http\Resources\SimpleOrganizationEmployeeResource;
...
class HeroSectionResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'created_by' => new SimpleOrganizationEmployeeResource($this->createdBy),
        ];
    }
}
